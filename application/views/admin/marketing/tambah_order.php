  ...
  <div class="col-md-12">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li role="presentation"><a href="<?php echo site_url('marketing/sudah_bayar');?>">Sudah Bayar</a></li>
      </ul>
              ...
              <div class="box box-primary box-solid">
                ...
                <div class="box-body">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-8">
                      <input type="text" id="tgl_trans" value="<?php echo date('Y-m-d H:i:s');?>" id="date" class="form-control"/>
  ...
  $(document).ready(function(){
    ...
    // ambil data kabupaten ketika data memilih provinsi
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if(response.status == "ok"){
                        alert("sukses");
                        window.location.href = '<?php echo base_url('marketing/order'); ?>';
      ...
      function penjualan_status(){
        ...
        var tanggal_transaksi = $("#tgl_trans").val();
