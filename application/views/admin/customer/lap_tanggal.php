...
<input type="hidden" name="akhir" id="akhir" value="<?php echo $akhir; ?>">
...
<script type="text/javascript">
  $(document).ready(function(){
    ...
    function report(status){
      ...
      var awal = $('#awal').val();
      var akhir = $('#akhir').val();
      var data = "status="+status+"&awal="+awal+"&akhir="+akhir;
      //alert(data);
      $.ajax({
        type: 'POST',
        url: "<?php echo base_url('admin/pelanggan/report_tanggal'); ?>",
        data: data,
