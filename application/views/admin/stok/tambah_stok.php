                ...
                <form class="form-horizontal" method="POST">
                  <div class="box-body">
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Tambah Stok</label>
                        <div class="col-sm-8">
                          <input type="text" value="<?php echo set_value('stok') ?>" name="stok" placeholder="Tambah Stok" class="form-control" required/>
                        </div>
                      </div>
