<!-- Modal filter Tahun -->
<div class="modal fade" id="tahun_3">
  <div class="modal-dialog" style="width: 350px;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('admin/produk/stok_tahun')); ?>
...
<div class="modal fade" id="tanggal">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('admin/produk/stok_tanggal')); ?>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
...
<!-- Modal filter bulan -->
<div class="modal fade" id="bulan_3">
  <div class="modal-dialog" style="width: 450px;">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <?php echo form_open(base_url('admin/produk/stok_bulan')); ?>
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              <label>Tahun</label>
