...
// Form open
echo form_open_multipart(base_url('admin/pelanggan/edit_calon/'.$calon->id_calon), ' class="form-horizontal"');
 ?>
<!-- START CUSTOM TABS -->
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
              <li role="presentation" class="active"><a href="#tab_1">Edit Calon Customer</a></li>
                ...
                <form class="form-horizontal" method="POST">
                  <div class="box-body">
                    <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" class="form-control" value="<?php echo $calon->id_calon?>" disabled/>
                          <input type="hidden" name="id_pelanggan" class="form-control" value="<?php echo $calon->id_calon?>"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Nama Customer</label>
                        <div class="col-sm-8">
                          <input type="text" value="<?php echo $calon->nama_calon?>" name="nama_pelanggan" placeholder="Nama Customer" class="form-control" required/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="alamat">Alamat</label>
                        <div class="col-sm-8">
                          <textarea name="alamat" placeholder="Alamat" class="form-control"/><?php echo $calon->alamat?></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control" id="form_prov" name="provinsi">
                            ...
                            <option value="<?php echo $provinsi->kode ?>"<?php if($calon->provinsi==$provinsi->nama){ echo "selected"; } ?>><?php echo $provinsi->nama ?></option>
                          <?php } ?>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control" id="form_kab" name="kabupaten">
                            <option><?php echo $calon->kabupaten?></option>
                          </select>
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <select class="form-control" id="form_kec" name="kecamatan">
                            <option><?php echo $calon->kecamatan?></option>
                          </select>
                        </div>
                      </div>
                    </div>
                    <div class="col-md-6">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-sm-8">
                          <input type="text" value="<?php echo $calon->no_hp?>" name="no_hp" placeholder="No. HP" class="form-control"/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label">Komoditi</label>
                        <div class="col-sm-8">
                          <input type="text" value="<?php echo $calon->komoditi?>" name="komoditi" placeholder="Komoditi" class="form-control" required/>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-sm-4 control-label" for="alamat">Keterangan</label>
                        <div class="col-sm-8">
                          <textarea style="height: 100px;" name="keterangan" placeholder="Keterangan" class="form-control"/><?php echo $calon->keterangan?></textarea>
                        </div>
                      </div>
                  ...
                  <div class="box-footer">
                    <div class="col-md-3 col-md-offset-4">
                      <a href="<?php echo base_url('admin/pelanggan/calon_customer') ?>" class="btn btn-default">Cancel</a>
